...
namespace BoilerApi.Service.V1
{
    public static class Common
    {
        ...
        public static ApiProblemDetails ToProblemDetails(this Error error,
            ...
            ApiProblemDetails.Create(GENERIC_ERROR_TITLE, (int)error.StatusCode, error.Faults.Map(e => new Fault
            {
