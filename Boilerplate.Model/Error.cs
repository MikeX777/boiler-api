...
{
    /// <summary>
    /// A common Error class used to map Proxy error responses.
    /// </summary>
    public class Error
    {
        /// <summary>
    ...
    /// <summary>
    /// A source of where the error originated.
    /// </summary>
    public enum ErrorSource
    {
        ...
        Unspecified = 0,
        /// <summary>
        /// An error occurred while trying to retrieve a token.
        /// </summary>
        TokenProvider = 1,

        /// <summary>
        /// An error coming from the BoilerAPI.
        /// </summary>
        BoilerAPI = 100
    }
